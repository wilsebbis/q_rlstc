...
Generated: 2026-03-06T01:27:46.429283
...
══════════════════════════════════════════════════════════════════════
  ...
  2026-03-06T01:26:27.838475
  Git: 1e9b7064b1fd
  Python: 3.13.12  |  NumPy: 2.4.1
  Experiments: D1, E1
  Data: 4 trajectories, 1 epochs
  Seed: 42
...
════════════════════════════════════════════════════════════════════════════════
  ...
  4 trajectories, no learning, no reward shaping
  NOTE: Tests metric degeneracy only — reward alignment is separate.
════════════════════════════════════════════════════════════════════════════════

 CutProb  ActualCUT%     ValCR    nValCR    wValCR   #Segs   AvgLen
────────────────────────────────────────────────────────────────────────────────
      0%        0.0%    1.0000    0.0020    0.0010       1    488.0
      5%        5.7%    0.1741    0.0182    0.0049      29     17.8
     10%       10.9%    0.2042    0.0293    0.0106      54     10.0
     20%       18.7%    0.2165    0.0437    0.0185      92      6.3
     30%       25.3%    0.2024    0.0479    0.0227     124      4.9
     50%       35.7%    0.2071    0.0588    0.0314     175      3.8
     80%       44.6%    0.2108    0.0667    0.0384     218      3.2
    100%       49.7%    0.2092    0.0697    0.0417     243      3.0
────────────────────────────────────────────────────────────────────────────────

  ✓  ValCR is NOT monotonically decreasing with CUT%.
     Best ValCR = 0.1741 at CUT = 5%

  [Auto-Save] Saving intermediate results to results/smoke...
...
See `thesis_results_20260306_012746.json` for machine-readable data.
