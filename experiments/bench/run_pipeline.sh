...
python -m pip install numpy qiskit qiskit-aer matplotlib tensorflow==1.15.0 || \
...
PYTHONPATH=. python experiments/bench/run_bench.py --mode paper_baseline --backend classical

echo "[3/4] Running Quantum Paper Baseline..."
PYTHONPATH=. python experiments/bench/run_bench.py --mode paper_baseline --backend quantum

echo "[4/4] Generating Comparison Plots..."
PYTHONPATH=. python experiments/bench/plotting.py --mode paper_baseline
